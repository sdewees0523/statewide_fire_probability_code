...
# Reading in shapefile with all independent variables
...
# Reading in cultivated raster to use as raster template
...
for (year_i in years) {
  ...
  # Convert fire probability shapefile to raster using cultivated raster as template 
  ...
  write_stars(pred_raster, here("02_WRF", 
                                ...
                                paste0("yearly_fullmodel_prediction_", year_i, ".tif")))
}
